...
# Form implementation generated from reading ui file 'textb.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("icon/fakelogo.ico"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off)
        ...
        self.textEdit.setStyleSheet("background-color: rgb(233, 233, 225);\n"
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Empty file"))
